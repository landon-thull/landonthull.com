    ...
    <div className="h-screen flex flex-col justify-center items-center bg-fixed bg-gradient-to-b from-black to-gunmetal">
      <div className="w-full flex flex-col text-center justify-center content-middle md:w-1/2">
        ...
        <div className="mt-4 flex gap-4 w-full flex-wrap justify-center">
          <h3 className="inline whitespace-nowrap px-4 py-2 bg-black rounded-lg text-blue">Software Engineer</h3>
          <h3 className="inline whitespace-nowrap px-4 py-2 bg-black rounded-lg text-blue">CS Student</h3>
          <h3 className="inline whitespace-nowrap px-4 py-2 bg-black rounded-lg text-blue">Coding Enthusiast</h3>
        </div>
      </div>
